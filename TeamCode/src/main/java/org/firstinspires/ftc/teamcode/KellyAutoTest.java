...
//        Terry.rightBackDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        Kelly.gyroDrive(DRIVE_SPEED,57,0.0);
        Kelly.gyroDrive(DRIVE_SPEED,-57,0);
        Kelly.gyroDrive(DRIVE_SPEED, 5.0, 0.0);    // Drive FWD 5 inches
        Kelly.gyroSlideR(DRIVE_SPEED, 24.0, 0.0);  //slide right 24 inches
        Kelly.gyroHold(TURN_SPEED,0,2);
        Kelly.gyroSlideL(DRIVE_SPEED, 45.0, 0.0);  //slide left 45 inches
        Kelly.gyroHold(TURN_SPEED,0,2);
        Kelly.gyroDrive(DRIVE_SPEED,10,0); //drive forward 10 inches
        Kelly.gyroHold(TURN_SPEED,0,2);
        Kelly.gyroSlideR(DRIVE_SPEED, 48.0, 0.0);  //slide right 48 inches
