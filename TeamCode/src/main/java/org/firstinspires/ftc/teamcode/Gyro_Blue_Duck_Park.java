...
//@Disabled
public class Gyro_Blue_Duck_Park extends LinearOpMode {
   ...
   public void gyroDrive ( double speed,
      ...
      int     newLeftTarget;
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                   (Kelly.leftDrive.isBusy() && Kelly.rightDrive.isBusy() && Kelly.leftBackDrive.isBusy() && Kelly.rightBackDrive.isBusy())) {
